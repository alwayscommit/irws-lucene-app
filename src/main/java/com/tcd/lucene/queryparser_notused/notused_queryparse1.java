...
2 functions which simplifies the query file.
The original query file has empty new lines,
* topics (whose words are anyways repeated in description and narrative)
* Not a single line narrative or description

These are corrected and the two functions together outputs a simplified file.
...
public class notused_queryparse1 {

    public notused_queryparse1() {
    }
